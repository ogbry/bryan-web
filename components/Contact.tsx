...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // await fetch('YOUR_ONESIGNAL_API_ENDPOINT', {
      //   method: 'POST',
      //   headers: {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-b from-white to-slate-50 dark:from-slate-900 dark:to-slate-900/50">
      <div className="container max-w-5xl px-6">
        ...
        >
          ...
          <p className="text-slate-600 dark:text-slate-400 text-lg max-w-2xl mx-auto">
            Have a project in mind or just want to connect? Fill out the form below and I'll get back to you as soon as possible.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-8 items-start">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="font-medium text-slate-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition-colors break-all"
                  >
          ...
          >
            <form onSubmit={handleSubmit} className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-8 shadow-xl">
